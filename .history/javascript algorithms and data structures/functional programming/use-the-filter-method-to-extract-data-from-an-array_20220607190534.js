...
// use filter method
const filtered = watchList.filter(film => Number(film.imdbRating) >= 8.0 ? watchList.map(film => `Title: ${film.Title}, Ratings: ${film.imdbRating}`) : null);

// filteredList = filtered ? 

// check filtered
log(filtered.map(film => film.Title));
