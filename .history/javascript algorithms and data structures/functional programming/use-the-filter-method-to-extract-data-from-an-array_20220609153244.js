...
filteredList = filteredList.map(film => ratings.push({ title: film["Title"], rating: film["imdbRating"] }));

// store stringified array in filteredList
// filteredList = JSON.stringify(newArray);
ratings = JSON.stringify(filteredList, null, "");
log(ratings);
