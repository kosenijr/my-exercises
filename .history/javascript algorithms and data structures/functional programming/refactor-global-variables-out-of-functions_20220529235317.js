...
// include new param and replace bookList: addToList
function add(addToList, bookName) {

    addToList.push(bookName);
    return addToList;
...
// Change code below this line
// include new param and replace bookList: removeFromList
function remove(removeFromList, bookName) {
    const book_index = removeFromList.indexOf(bookName);
    if (book_index >= 0) {

        removeFromList.splice(book_index, 1);
...
// log function calls
console.log(
    add(bookList, "Harry Potter and the Goblet of Fire"), tracks
)