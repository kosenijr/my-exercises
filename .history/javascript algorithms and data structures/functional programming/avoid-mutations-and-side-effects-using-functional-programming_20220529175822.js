...
/*
NOTES
returning fixedValue += 1 would be incorrect in this situation because the ask was for the function to return the value of fixedValue to be incremented by one, not for the 
*/
