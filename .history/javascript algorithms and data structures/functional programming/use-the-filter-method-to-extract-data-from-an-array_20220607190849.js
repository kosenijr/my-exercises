...
// use filter method, store under filteredList.
filteredList = watchList.filter(film => Number(film.imdbRating) >= 8.0);

// check filtered

// use map method to retrieve titles and ratings, store 
log(filteredList.map(film => log(`Title: ${film.Title}, Rating: ${film.imdbRating}`)));
