...
function chunkArrayInGroups(arr, size) {
  ...
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]]ups(arr, size, newarr, freq, temp) {
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
  ...
  chunkArrayInGroups([0, 1, 2, 3, 4, 5, 6, 7, 8], 2);
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]]sole, setup frequency and store, new arr
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
...
function chunkArrayInGroups(arr, size) {
  ...
  chunkArrayInGroups([0, 1, 2, 3, 4, 5, 6, 7, 8], 2);
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]].length / size);
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
...
function chunkArrayInGroups(arr, size) {
  ...
  chunkArrayInGroups([0, 1, 2, 3, 4, 5, 6, 7, 8], 2);
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]]avigate
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
  ...
  chunkArrayInGroups([0, 1, 2, 3, 4, 5, 6, 7, 8], 2);
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]]freq; k++) {
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
...
function chunkArrayInGroups(arr, size) {
  ...
  chunkArrayInGroups([0, 1, 2, 3, 4, 5, 6, 7, 8], 2);
  // return [[0, 1], [2, 3], [4, 5], [6, 7], [8]]plice(0, size)
function chunkArrayInGroups(arr, size) {
    // abbrev log to console, setup frequency and store, new arr
    const log = console.log;
    const freq = Math.ceil(arr.length / size);
