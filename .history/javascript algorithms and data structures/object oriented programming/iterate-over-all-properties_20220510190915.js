...
// create for in loop for easy navigation
for (property in beagle) {
    // console.log(property);
    // ternary statement
    let condition = beagle.hasOwnProperty(property) ? ownProps.push(property) : prototypeProps.push(property);
}
console.log(ownProps, prototypePropes)
