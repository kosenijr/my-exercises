...
function whatIsInAName(collection, source) {
    ...
    const valuesColl = Object.values(collection);
    // log(values);

    // create a for loop for navigation
    for (let b = 0; b < valuesColl.length; b++) {
        // collection
        // log(
        //     values[b],
        ...
        const innerKeys = Object.keys(values[b]);
        const innerValues = Object.values(values[b]);
