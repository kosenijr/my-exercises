...
Waiting:Dispatching loginAction should update the login property in the store state to true.
Waiting:If the action is not of type LOGIN, the store should return the current state.
