...
Tests
Passed:The action creator addNoteText should return an object with keys type and text.
Passed:Dispatching an action of type ADD_NOTE with the addNoteText action creator should update the state to the string passed to the action creator.
