...
/*
NOTES
- commenting out the length property of line 3 provides each inclusive character of the regex on line 4. Specifically, this exercise shows that '/\D/g' provides every character within movieName: absent the numbers, but consisting of the colon, letter characters, and spaces. 
 */