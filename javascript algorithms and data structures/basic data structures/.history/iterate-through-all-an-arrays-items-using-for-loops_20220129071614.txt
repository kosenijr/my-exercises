...
function filteredArray(arr, elem) {
  ...
  my other solution, but not with for loop
   */
  // for (const nestedArrs of arr) {
  //   // console.log(nestedArrs);
  //   if (!nestedArrs.includes(elem)) {
  //     // console.log(nestedArrs);
  //     newArr.push(nestedArrs);
  //   }
  // }
...
/*
- as tempting as it is, working within one for loop for a resolve before complicating things with two or more loops.
*/