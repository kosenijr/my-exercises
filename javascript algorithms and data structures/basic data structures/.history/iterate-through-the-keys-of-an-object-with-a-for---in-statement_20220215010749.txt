...
function countOnline(usersObj) {
  ...
  for (let user in usersObj) {
    ...
    // for in: online
    // fill up array: user
    let values = Object.values(usersObj[user]).toString();
    // // check grab: s
    // console.log(
    //   values,
    //   fillArr.
...
/*
NOTES
- Counting keys in an object can be difficult. My strategy was to transfer the conditioned-related user(s) to an array (fillArr) to be counted, as per the .length() method.
*/