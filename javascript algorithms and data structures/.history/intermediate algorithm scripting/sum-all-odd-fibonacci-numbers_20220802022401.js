...
// abbrev. logs to console
const log = console.log;
// initially populate array with two  of 1.
let arr = [1, 1];
...
const sumFibs = (num) => {
    ...
    for (let b = 1; b <= num; b++) {
        arr.push(b);
        // filter out numbers that do not meet sequence
        arr.filter(elem => elem !== (arr.at(-2) + arr.at(-1)) ? arr.slice(arr.indexOf(elem)) : null);
