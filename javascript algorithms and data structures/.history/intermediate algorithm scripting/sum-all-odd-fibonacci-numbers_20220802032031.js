...
const sumFibs = (num) => {
    ...
    arr.filter(elem => (elem <= num) && (elem % 2 === 1) ? arr.reduce((prevVal, currVal) => prevVal,     arr.filter(elem => (elem <= num) && (elem % 2 === 1) ? arr.reduce((prevVal, currVal) => prevVal, currVal) : null);
    ) : null);
