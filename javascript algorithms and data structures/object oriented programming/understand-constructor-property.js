...
log('let\'s start!');
// constructor with general param
...
// example
let connor = new Dog();
// check constructor property of object, also confirm instanceof
log(connor.constructor === Dog, connor instanceof Dog)
...
// joined Dog frat?
log(`Dog: ${joinDogFraternity(connor)}`);

// joined Bird frat?
log(`Bird: ${joinBirdFraternity(connor)}`);
