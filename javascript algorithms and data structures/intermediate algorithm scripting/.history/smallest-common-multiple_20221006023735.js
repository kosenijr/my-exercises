...
function smallestCommons(arr) {
    ...
    let [newarr, [min, max], arrPrime, arrPrior, arrNow, arrPriorComp, log] = [[], arr, [], [], [], [], console.log];
    ...
    for (let b = min; b <= max; b++) {
        // push b into newarr to create a numerator array
        newarr.push(b);
    ...
    log(newarr, arrPrime); // logs the numerator and denominator arrays, respectively
