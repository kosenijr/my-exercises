...
function orbitalPeriod(arr) {
    ...
    const [pi, sr, p, round, mu, earthRadius] = [Math.PI, (num) => Math.sqrt(num), (base, exp) => Math.pow(base, exp), (dec) => Math.round(dec), 398600.4418, 6367.4447];const log = console.log;
    // log('ready to solve!');
    function orbitalPeriod(arr) {
      // included and stored pi and square root function, as well as an exponential function, rounder, gravitational parameter, and earth's radius: changed GM to mu for the purpose of this exercise.
    ...
    // should return [{name : "iss", orbitalPeriod: 5557}, {name: "hubble", orbitalPeriod: 5734}, {name: "moon", orbitalPeriod: 2377399}].const log = console.log;
// log('ready to solve!');
function orbitalPeriod(arr) {
  // included and stored pi and square root function, as well as an exponential function, rounder, gravitational parameter, and earth's radius: changed GM to mu for the purpose of this exercise.
  const [pi, sqrt, p, round, mu, earthRadius] = [Math.PI, Math.sqrt, Math.pow, Math.round, 398600.4418, 6367.4447];
